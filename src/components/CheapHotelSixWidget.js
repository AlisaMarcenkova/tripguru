...
function CheapHotelSixWidget() {
  const scriptRef = useRef();

  useEffect(() => {
    const currentScriptRef = scriptRef.current;
    const script = document.createElement('script');
    script.src = 'https://tp.media/content?currency=usd&trs=232358&shmarker=438659&host=search.hotellook.com&locale=en&hotel_id=312198&nobooking=&powered_by=false&width=505&primary=%23ff8e00&special=%23e0e0e0&promo_id=4063&campaign_id=101';
    script.async = true;
...
export default CheapHotelSixWidget;