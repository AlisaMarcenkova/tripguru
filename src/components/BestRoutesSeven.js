...
function BestRoutesSeven() {
  const scriptRef = useRef();

  useEffect(() => {
    const currentScriptRef = scriptRef.current;
    const script = document.createElement('script');
    script.src = 'https://tp.media/content?currency=usd&trs=232358&shmarker=438659&destination=IST&target_host=www.aviasales.com%2Fsearch&locale=en&limit=6&powered_by=true&width=260&primary=%230085FF&promo_id=4044&campaign_id=100';
    script.async = true;
...
export default BestRoutesSeven;